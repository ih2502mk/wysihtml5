...
b="string"===typeof b?{rename_tag:b}:b}else if(a.firstChild)b={rename_tag:d};else return null;g=a.ownerDocument.createElement(b.rename_tag||g);var f={},j=b.set_class,k=b.add_class,i=b.set_attributes,m=b.check_attributes,n=h.classes,p=0,q=[];b=[];var r=[],v=[],t;i&&(f=wysihtml5.lang.object(i).clone());if(m)for(t in m)if(i=u[m[t]])i=i(c(a,t)),"string"===typeof i&&(f[t]=i);j&&q.push(j);if(k)for(t in k)if(i=o[k[t]])j=i(c(a,t)),"string"===typeof j&&q.push(j);n["_wysihtml5-temp-placeholder"]=1;(v=a.getAttribute("class"))&&
